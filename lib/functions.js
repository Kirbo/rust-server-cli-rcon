...
var tools = {
    ...
    header: function () {
        ...
        var scrollText = "scroll: " + tools._currentScroll + ' - ' + maxScroll + ' / ' + tools._log.length;
        ...
        if (websocket._serverInfo.Hostname) {
            ...
            var serverInfo = "Memory: " + websocket._serverInfo.Memory + ', fps: ' + websocket._serverInfo.Framerate + ', ent: ' + websocket._serverInfo.EntityCount;
